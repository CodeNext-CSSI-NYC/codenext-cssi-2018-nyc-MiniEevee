...
//
// let num1 = sumDouble(1, 2);
// console.log(num1);
// let num2 = sumDouble(3, 2);
// console.log(num2);
// let num3 = sumDouble(2, 2);
// console.log(num3);
//
...
// // Call it a few times and console.log the result, to make sure it is working
//
// let first = makes10(9, 10);
// console.log(first);
// let second = makes10(9, 9);
// console.log(second);
// let third = makes10(1, 9);
// console.log(third);
//
...
let parrot1 = parrotTrouble(true, 6);
console.log(parrot1);
let parrot2 = parrotTrouble(true, 7);
console.log(parrot2);
let parrot3 = parrotTrouble(false, 6);
console.log(parrot3);
