...
// let tries = 1;
// let guess = readline.question("Guess a password: ").toUpperCase();
// if (guess != "EEVEE") {
//   guess = readline.question("Incorrect. Try again: ").toUpperCase();
//   tries += 1;
// }
// if (guess == "EEVEE") {
//   console.log("You got the password. It took " + tries + " attempts to guess correctly");
// }
